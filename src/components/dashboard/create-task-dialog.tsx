...
const taskSchema = z.object({
  ...
  assignedStudent: z.object({
    id: z.string(),
    name: z.string(),
  }, { required_error: 'Please assign this task to a student.'}),
});
...
export function CreateTaskDialog({ lecturerId, students }: CreateTaskDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the details below to assign a new task to a student.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
